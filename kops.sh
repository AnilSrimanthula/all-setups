...
aws s3api create-bucket --bucket Anil.k8s.local --region us-east-1
aws s3api put-bucket-versioning --bucket Anil.k8s.local --region us-east-1 --versioning-configuration Status=Enabled
